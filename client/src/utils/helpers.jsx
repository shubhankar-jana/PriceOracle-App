...
import { FiTrendingUp, FiLayers, FiCpu, FiBarChart2, FiDollarSign } from 'react-icons/fi'
...
export const getCategoryIcon = (category) => {
  ...
  if (cat === 'stock') return <FiTrendingUp size={16} />
  if (cat === 'commodity') return <FiLayers size={16} />
  if (cat === 'crypto') return <FiCpu size={16} />
  if (cat === 'currency') return <FiDollarSign size={16} />
